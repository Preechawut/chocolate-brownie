...
export function Footer() {
  ...
  return (
    <footer className="border-t border-[var(--border)] px-6 pt-10 pb-8">
          ...
          <div className="flex items-center gap-1.5">
            {enabledSocials.map(({ label, href, external }) => (
              <a
                ...
                rel="noopener noreferrer"
                aria-label={label}
                className="flex h-7 w-7 items-center justify-center border border-[var(--border2)] bg-[var(--surface)] text-t3 transition-colors hover:border-t1 hover:text-t1"
              >
                {SOCIAL_ICONS[label]}
              </a>
            ))}
