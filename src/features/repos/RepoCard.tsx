      ...
      <div className="flex items-start justify-between gap-3">
        ...
        >
          <div className="flex items-center gap-2">
            <span
              className={`text-[11px] text-t3 transition-transform duration-200 ${expanded ? 'rotate-90' : ''}`}
            >
              ›
            </span>
            <span className="text-[14px] font-bold text-t1 group-hover:underline underline-offset-2">
              {repo.name}
            </span>
          </div>
